...
def lcs(a: str, b: str) -> Dict[str, object]:
    ...
    The implementation uses bottom-up dynamic programming over an
    (m+1) x (n+1) score matrix, then backtracks to recover one
    maximum-length subsequence. Case sensitivity is preserved.
    """
    m, n = len(a), len(b)
...
def lcs_memoized(a: str, b: str) -> str:
    """Alternative recursive-with-memoization formulation.

    Useful for benchmarking against the tabular form and for
    educational comparison (Cormen et al., 2022).
    """
