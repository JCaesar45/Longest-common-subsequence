 ...
 *
 * Immutable utility class. The DP table uses int[][] because the
 * maximum LCS length for typical inputs is well within int range,
 * and it keeps the code portable across every JDK target.
 */
